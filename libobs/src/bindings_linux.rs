...
pub const FE_INVALID: _bindgen_ty_3 = 1;
pub const __FE_DENORM: _bindgen_ty_3 = 2;
pub const FE_DIVBYZERO: _bindgen_ty_3 = 4;
pub const FE_OVERFLOW: _bindgen_ty_3 = 8;
pub const FE_UNDERFLOW: _bindgen_ty_3 = 16;
pub const FE_INEXACT: _bindgen_ty_3 = 32;
pub type _bindgen_ty_3 = ::std::os::raw::c_uint;
pub const FE_TONEAREST: _bindgen_ty_4 = 0;
pub const FE_DOWNWARD: _bindgen_ty_4 = 1024;
pub const FE_UPWARD: _bindgen_ty_4 = 2048;
pub const FE_TOWARDZERO: _bindgen_ty_4 = 3072;
...
pub const obs_nix_platform_type_OBS_NIX_PLATFORM_INVALID: obs_nix_platform_type = 0;
pub const obs_nix_platform_type_OBS_NIX_PLATFORM_X11_EGL: obs_nix_platform_type = 1;
pub const obs_nix_platform_type_OBS_NIX_PLATFORM_WAYLAND: obs_nix_platform_type = 2;
pub type obs_nix_platform_type = ::std::os::raw::c_uint;
...
#[doc = " Sets the Unix platform.\n @param platform The platform to select."]
    pub fn obs_set_nix_platform(platform: obs_nix_platform_type);
#[doc = " Gets the host platform."]
    pub fn obs_get_nix_platform() -> obs_nix_platform_type;
#[doc = " Sets the host platform's display connection.\n @param display The host display connection."]
    pub fn obs_set_nix_platform_display(display: *mut ::std::os::raw::c_void);
#[doc = " Gets the host platform's display connection."]
    pub fn obs_get_nix_platform_display() -> *mut ::std::os::raw::c_void;
}