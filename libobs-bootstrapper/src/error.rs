...
impl std::fmt::Display for ObsBootstrapError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            ObsBootstrapError::HashMismatchError => write!(f, "Hash mismatch error: The downloaded file's hash did not match the expected hash"),
            ObsBootstrapError::InvalidState => write!(f, "Invalid state error: This error should never happen, please report to maintainers"),
        }
    }
}
